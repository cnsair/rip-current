...
USE_FOAM_LOSS       = True    # master switch / ablation arm selector
FOAM_LAMBDA_MAX     = 0.3     # peak weight of the physical term
...
FOAM_MARGIN         = 0.10    # target Michelson contrast (Step-1 median ~0.111)
